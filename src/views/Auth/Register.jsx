...
function Register() {
  ...
  return (
    <div>
      <button onClick={onClickToLogin}>X</button>
      <h3>Daftar</h3>
      <p>background</p>
      <p>logo</p>
      <p>buat akun senjanimu</p>
      <br />
      <InputItem
      ...
      <p>{notePassword}</p>
      <InputItem placeholder="baariq azhar" type="text" onChange={onChangeNama}>
        Nama
      </InputItem>
      <TextareaItem
        title="Alamat"
